...
function pegarUsuarioPeloId(idUsuario) {
    axios.get(`http://infopguaifpr.com.br:3052/pegarUsuarioPeloId/${idUsuario}`)
        .then(response => {
            ...
            document.querySelector('#editarNome').value = usuario.nome;
            document.querySelector('#editarEmail').value = usuario.email;
            document.querySelector('#editarDisciplina').value = usuario.disciplina;
            
            
            document.querySelector('#btnSalvarEdicao').addEventListener('click', () => {
                const novoNome = document.querySelector('#editarNome').value;
                const novoEmail = document.querySelector('#editarEmail').value;
                const novaDisciplina = document.querySelector('#editarDisciplina').value;
                
               
                atualizarUsuario(idUsuario, novoNome, novoEmail, novaDisciplina);
            });
...
function atualizarUsuario(idUsuario, novoNome, novoEmail, novaDisciplina) {
